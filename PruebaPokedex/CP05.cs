...
namespace PruebaPokedex
{
    class CP05 : IPrueba
    {
        ...
        // Método que prueba la funcionalidad de editar un pokemon
        private void EditarPokemones()
        {
            ...
            try
            {
                ...
                driver.GetScreenshot().SaveAsFile("./Capturas/CP05-1.jpg");
                // Localizar y hacer clic en el botón "Editar" del pokemon "Bulbasaur"
                ...
                driver.GetScreenshot().SaveAsFile("./Capturas/CP05-2.jpg");
                // Localizar el campo "Name", borrar su contenido e ingresar el texto "nuevo"
                element = driver.FindElement(By.Id("Name"));
                element.Clear();
                element.SendKeys("nuevo");
                // Tomar otra captura de pantalla y guardarla en el directorio "Capturas"
                driver.GetScreenshot().SaveAsFile("./Capturas/CP05-3.jpg");
                // Localizar y hacer clic en el botón "Guardar"
                element = driver.FindElement(By.Id("btnGuardar"));
                element.Click();
                // Tomar otra captura de pantalla y guardarla en el directorio "Capturas"
                driver.GetScreenshot().SaveAsFile("./Capturas/CP05-4.jpg");
            }
            finally
            {
                // Cerrar el navegador
